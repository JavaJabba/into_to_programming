...
#basic enter age, cast to int, calculate average then output
'''
# average ages:
# get the first age
...
#another iteration on the mean age function but assigning a variable within the input.
'''
...
'''
#this block needs an indent for the code to work withing the "def". Fixed below
...
#this block assigns an id to each age variable.
'''
